...
#ifndef GENERALIZED_DPP_SWIFT_H
#define GENERALIZED_DPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="generalized_dpp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15generalized_dpp11AppDelegate")
...
SWIFT_CLASS("_TtC15generalized_dpp17MainFlutterWindow")
