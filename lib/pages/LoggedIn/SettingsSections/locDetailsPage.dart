...
class LocalizationDetailsSection extends StatefulWidget {
  const LocalizationDetailsSection({super.key});

  @override
  State<LocalizationDetailsSection> createState() => _localDetailsState();
}
