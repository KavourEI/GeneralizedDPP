...
class PrivacyDetailsSection extends StatefulWidget {
  const PrivacyDetailsSection({super.key});

  @override
  State<PrivacyDetailsSection> createState() => _privacySectionState();
}

class _privacySectionState extends State<PrivacyDetailsSection> {
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    _buildSectionDevider("Account Info"),

                    const SizedBox(height: 10),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        _buildSettingItem('Terms of usage'),
                        ElevatedButton(
                          onPressed: () => _downloadBillingHistory(),
                          child: const Text('Terms of Usage'),
                        ),
                      ],
                    ),
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        _buildSettingItem('Delect Account'),
                        ElevatedButton(
                          onPressed: () => _downloadBillingHistory(),
