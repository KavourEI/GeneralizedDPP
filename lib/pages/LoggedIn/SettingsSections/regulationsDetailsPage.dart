...
class RegulationsDetailsSection extends StatefulWidget {
  const RegulationsDetailsSection({super.key});

  @override
  State<RegulationsDetailsSection> createState() => _regulationsState();
}
